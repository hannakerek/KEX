...
class Maze(tk.Tk, object):
    ...
    def resetAll(self):
        ...
        self.canvas.delete(agentList[1])
    ...
    def current_state(self,n):
        ...
        for k in range(len(agentList)):
            if k!=n:
                enemy = np.array(self.canvas.coords(agentList[k])[:2])
        ...
        distance = np.array([distance33[0],distance33[1],distance33[2],distance33[3],distance33[4],distance33[5],
                             ...
                             distance2[0], distance2[1],distance1[0],distance1[1]])
        return distance
    ...
    def step(self, action,n):
        ...
        return  reward, done, collision, col
